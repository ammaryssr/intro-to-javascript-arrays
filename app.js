const movies = ['gladiator','warrior','thor'];
...
splice(Index, 1, 'sushi', 'cupcake') removes 'pizza' and inserts
...
const allFoods = foods.join(' -> '); //not that clear on use
